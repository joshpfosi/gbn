...
GbnReceiver::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::GbnReceiver")
    ...
    .AddAttribute ("Port", "Port on which we listen for incoming packets.",
                   UintegerValue (9),
                   MakeUintegerAccessor (&GbnReceiver::m_port),
...
GbnReceiver::StartApplication (void)
{
  ...
  m_socket6->SetRecvCallback (MakeCallback (&GbnReceiver::HandleRead, this));
}

void 
GbnReceiver::StopApplication ()
{
  NS_LOG_FUNCTION (this);
...
void 
GbnReceiver::HandleRead (Ptr<Socket> socket)
{
